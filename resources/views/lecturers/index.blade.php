...
<form class="d-inline" action="{{route('lecturers.destroy', [$item->id])}}" method="POST" onsubmit="return confirm('Yakin hapus data?')"> @csrf @method('delete') <button class="btn btn-danger btn-sm" type="submit">Delete</button> </form>
</a>
</td>
</tr>
@endforeach
